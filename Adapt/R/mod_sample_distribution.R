...
distribution_sample_Server <- function(id, n_participants, tex_name, n_days, decision_pts) {
  moduleServer(id,
...
server <- function(input, output, session) {
  ...
  result <- distribution_sample_Server("sample_variable", 
                                       tex_name = reactive(tex_var_name(input$sim_var_name)),
